package by.it.group451003.mazalevich.lesson14;
...
public class PointsA {
    public static void main(String[] args) {
        ...
        // Создаем DSU с индексами вместо объектов
        DSU dsu = new DSU(count);

        // Объединяем точки - используем СТРОГОЕ сравнение < как в тесте
        for (int i = 0; i < count; i++) {
    ...
    // Простая реализация DSU с индексами
    static class DSU {
